...
# What is mean by Discussion (Why do those findings matter?) 
...
The discussion section is where you interpret your research findings instead of simply presenting numbers or observations.

A good discussion should answer questions such as:
...
- The discussion is your opportunity to tell the story behind your results.
...
- While DL models are said to perform worse due to dataset size, no empirical evidence (e.g., learning curves or training loss) is provided. Consider including such analysis or tempering the claim.
- The manuscript is lengthy and repetitive in places. Please revise for clarity, conciseness, and tone consistency (avoid switching between first-person and third-person narrative). Ensure that all figures and tables are clearly labelled and explicitly referenced in 
